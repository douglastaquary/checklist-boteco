    ...
    try dbQueue.write { db in
      ...
      try db.execute(
        ...
        INSERT INTO User(name, email, password, area, workSector, permissionLevel, allowedAreas, createdAt,
          ...
          canViewInventoryInsights, canManageAdministrativeStock, canImportPurchases, mustChangePassword)
      ...
      if let existing = try UserRecord.fetchOne(
        ...
        try db.execute(
          ...
          UPDATE User SET name = ?, email = ?, area = ?, workSector = ?, permissionLevel = ?, allowedAreas = ?,
            ...
            canCreateInventoryCounts = ?, canViewInventoryInsights = ?, canManageAdministrativeStock = ?, canImportPurchases = ?, mustChangePassword = ?
          WHERE id = ?
          """,
          arguments: [
            ...
            remote.featurePermissions.canViewInventoryInsights, remote.featurePermissions.canManageAdministrativeStock, remote.featurePermissions.canImportPurchases,
    ...
    try dbQueue.write { db in
      try db.execute(
        ...
        arguments: [
          ...
          user.featurePermissions.canViewInventoryInsights, user.featurePermissions.canManageAdministrativeStock, user.featurePermissions.canImportPurchases,
    ...
    try dbQueue.write { db in
      try db.execute(
        ...
        arguments: [
          ...
          remoteUser.featurePermissions.canViewInventoryInsights, remoteUser.featurePermissions.canManageAdministrativeStock, remoteUser.featurePermissions.canImportPurchases,
    ...
    try dbQueue.write { db in
      try db.execute(
        ...
        UPDATE User SET canRegisterUsers = ?, canCreateActivities = ?, canEditUsers = ?,
          canCreateInventoryCounts = ?, canViewInventoryInsights = ?, canManageAdministrativeStock = ?, canImportPurchases = ?
        WHERE id = ?
        """,
        arguments: [
          ...
          permissions.canManageAdministrativeStock, permissions.canImportPurchases, userId,
        ]
      )
    }
  }
